...
public class MainActivity extends AppCompatActivity{
    ...
    private class SaveImageTask extends AsyncTask<Bitmap, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(MainActivity.this, "사진을 전송하였습니다.", Toast.LENGTH_SHORT).show();
                        ...
                        public void run() {
                            try {
                                ...
                                if(str.equals("true")){
                                    ...
                                    Toast.makeText(MainActivity.this, "얼굴이 나오게 다시 사진을 찍어주세요.", Toast.LENGTH_SHORT).show();
                                }
                                else {
