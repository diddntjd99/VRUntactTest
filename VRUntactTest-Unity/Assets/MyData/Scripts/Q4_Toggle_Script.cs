...
public class Q4_Toggle_Script : MonoBehaviour
{
    public Toggle q4_tgl_1;
    public Toggle q4_tgl_2;
    public Toggle q4_tgl_3;
    public Toggle q4_tgl_4;

    public string q4_Answer = "4";
    ...
    private void Awake()
    {
        q4_tgl_1.onValueChanged.AddListener((bool on) =>
        {
            if (on)
            {
                q4_Answer = "1";
        ...
        q4_tgl_2.onValueChanged.AddListener((bool on) =>
        {
            if (on)
            {
                q4_Answer = "2";
        ...
        q4_tgl_3.onValueChanged.AddListener((bool on) =>
        {
            if (on)
            {
                q4_Answer = "3";
        ...
        q4_tgl_4.onValueChanged.AddListener((bool on) =>
        {
            if (on)
            {
                q4_Answer = "4";
